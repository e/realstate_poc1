function setAddressAutocomplete() {
    ...
    autocomplete.addListener("place_changed", () => {
        ...
        //     console.log('Place and geometry viewport')
        //     console.log(place);
        //     console.log(place.geometry.viewport);
            // map.fitBounds(place.geometry.viewport);
        // } else {
        //     console.log('Place and geometry location')
    ...
    // Change input background color and update query if pressing enter
    const form = document.getElementById("index-form");
    form.addEventListener("focusin", (event) => {
      event.target.style.background = "#ccd5e6";
    });
